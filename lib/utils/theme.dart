  ...
  static ThemeData lightTheme = ThemeData(
    ...
    extensions: [
      AppColors(
        ...
        tableBorder: const Color(0xFFEEEEEE),
        badgeRed: const Color(0xFFFCEBEB),
        badgeRedText: const Color(0xFFA32D2D),
        badgeAmber: const Color(0xFFFAEEDA),
        badgeAmberText: const Color(0xFF854F0B),
        badgeGreen: const Color(0xFFEAF3DE),
        badgeGreenText: const Color(0xFF3B6D11),
      ),
    ],
  );
  ...
  static ThemeData darkTheme = ThemeData(
    ...
    extensions: [
      AppColors(
        ...
        amber: _amber,
        success: _green,
        sidebarBg: const Color(0xFF242438),
        sidebarActive: _primary,
        tableBorder: const Color(0xFF333355),
        badgeRed: const Color(0xFF501313),
        badgeRedText: const Color(0xFFF7C1C1),
